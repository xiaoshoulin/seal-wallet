module Seal.Wallet.Kernel.Accounts (
      createAccount
    , deleteAccount
    , updateAccount
    , updateAccountGap
...
import           Seal.Wallet.Kernel.DB.AcidState (CreateHdAccount (..), DB,
                     DeleteHdAccount (..), UpdateHdAccountGap (..),
                     UpdateHdAccountName (..))
import           Seal.Wallet.Kernel.DB.HdRootId (HdRootId)
import           Seal.Wallet.Kernel.DB.HdWallet (AccountName (..),
...
import           Seal.Wallet.Kernel.DB.Spec (Checkpoints (..),
                     initCheckpoint)
