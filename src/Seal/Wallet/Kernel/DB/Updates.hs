module Seal.Wallet.Kernel.DB.Updates (
    Updates(..)
  , noUpdates
  , addUpdate
  , removeNextUpdate
...
import           Seal.Wallet.Kernel.Util.StrictList (StrictList)
...
-- "Seal.Wallet.Kernel.NodeStateAdaptor" can be used to wait for these
-- notifications).
