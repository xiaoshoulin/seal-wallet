...
module Seal.Wallet.API.Response (
    Metadata (..)
  , ResponseStatus(..)
  , APIResponse(..)
  , JSONValidationError(..)
...
import           Seal.Wallet.API.Util.Servant
import           Seal.Wallet.API.Indices (Indexable, IxSet)
...
import           Seal.Wallet.API.Response.Filter.IxSet as FilterBackend
import           Seal.Wallet.API.Response.JSend (HasDiagnostic (..),
                     ResponseStatus (..))
import           Seal.Wallet.API.Response.Sort.IxSet as SortBackend
import           Seal.Wallet.API.V1.Errors (ToServantError (..))
import           Seal.Wallet.API.V1.Generic (jsendErrorGenericParseJSON,
                     jsendErrorGenericToJSON)
-- import           Seal.Util.Servant as ServantUtil
