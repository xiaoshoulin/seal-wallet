module Seal.Wallet.API.Response.Sort.IxSet where

import           Seal.Wallet.API.Indices (IsIndexOf, IxSet)
import qualified Seal.Wallet.API.Request.Sort as S
import           Seal.Wallet.Kernel.DB.Util.IxSet (toAscList, toDescList,
                     toList)
