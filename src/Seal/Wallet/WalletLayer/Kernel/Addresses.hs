...
module Seal.Wallet.WalletLayer.Kernel.Addresses (
    createAddress
  , getAddresses
  , validateAddress
  , importAddresses
...
import           Seal.Wallet.API.Response (SliceOf (..))
...
import           Seal.Wallet.Kernel.DB.Util.IxSet (AutoIncrementKey (..),
...
import           Seal.Wallet.WalletLayer (CreateAddressError (..),
