...
import           Seal.Crypto (ProtocolMagic, emptyPassphrase, hash)
...
import           Seal.Wallet.Kernel.DB.HdWallet.Create
                     (CreateHdRootError (..))
...
import           Seal.Wallet.Kernel.Wallets (CreateWalletError (..))
...
import qualified Seal.Wallet.API.Request as API
import qualified Seal.Wallet.API.Request.Pagination as API
import qualified Seal.Wallet.API.Response as V1
import           Seal.Wallet.API.V1.Handlers.Accounts as Handlers
import           Seal.Wallet.API.V1.Handlers.Wallets as Handlers
