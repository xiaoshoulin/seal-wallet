...
import           Seal.Wallet.API (InternalAPI, V1API)
import           Seal.Wallet.API.Response (ValidJSON)
import qualified Seal.Wallet.API.V1 as V1
import           Seal.Wallet.API.V1.Swagger ()
import qualified Seal.Wallet.API.V1.Swagger as Swagger
import           Seal.Chain.Update (ApplicationName (..), SoftwareVersion (..))
import           Seal.Util.CompileInfo (CompileTimeInfo (CompileTimeInfo),
                     gitRev)
