...
import           Seal.Wallet.API.V1.Swagger.Example (genExample)
import           Seal.Wallet.API.V1.Types (ErrNotEnoughMoney (..),
                     WalAddress (..), WalletError (..), exampleWalletId)

import           Test.Seal.Core.ExampleHelpers (exampleAddress)
