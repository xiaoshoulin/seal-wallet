...
import qualified Seal.Wallet.Kernel.CoinSelection.Generic.LargestFirst as Generic
import           Seal.Wallet.Kernel.CoinSelection.Generic.Random
                     (PrivacyMode (..))
import qualified Seal.Wallet.Kernel.CoinSelection.Generic.Random as Generic
