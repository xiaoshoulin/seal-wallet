...
{-------------------------------------------------------------------------------
  Interpreter for the wallet using the translated Seal types
-------------------------------------------------------------------------------}
...
-- | Interpreter for inductive wallets using the translated Seal types
--
  ...
  where
    ...
    walletBootT ctxt utxo = do
        ...
        where
            ...
            -- as a Seal Wallet with exactly one Account.
...
data EquivalenceViolation =
    -- | Seal wallet and pure wallet are not equivalent
    EquivalenceViolation {
